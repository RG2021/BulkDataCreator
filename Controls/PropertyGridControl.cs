...
namespace Mockit.Controls
{
    public class PropertyGridControl : BaseControl
    {
        ...
        //    var data = JsonSerializer.Deserialize<List<Common.Helpers.Properties.CategoryDefinition>>(methods);
        //    var rootWrapper = new Common.Helpers.Properties.RootWrapper(data);
